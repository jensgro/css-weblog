...
const { cacheDurations } = require(dataPath +"site.json")

const browserFeatures = require(dataPath + "browserFeatures.json")
const browsersByType = require(dataPath + "browsersByType.json")
